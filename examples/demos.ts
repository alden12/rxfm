...
import { HelloWorld, ChildrenExample, TaggedTemplateExample } from './basic/components.rts';
import {
  StylesExample, ClassExample, AttributesExample, DynamicStyles,
...
const Stack = (...children: ComponentChild[]): Component => Div.class('flex flex-col gap-2')(children);
...
export const DEMOS: Record<string, Demo> = {
  ...
  'tagged-template': { component: TaggedTemplateExample, source: componentsSrc },

  // Attributes & Styling section (first fence shows three; second shows the dynamic one).
  styles: { component: Stack(StylesExample, ClassExample, AttributesExample), source: attributesSrc },
  'dynamic-styles': { component: DynamicStyles, source: attributesSrc },

  // Remaining basics.
  conditional: { component: ConditionalComponentsExample, source: conditionalSrc },
