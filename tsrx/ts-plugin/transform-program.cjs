...
exports.relativeRuntimeSpecifier = relativeRuntimeSpecifier;
exports.getCompilerOptions = getCompilerOptions;
exports.createProgramFromText = createProgramFromText;
...
function createProgramFromText(ts, fileName, text, options, transform) {
