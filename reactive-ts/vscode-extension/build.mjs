// Bundles the tsserver plugin (reactive-ts/ts-plugin) into a single
// self-contained module at node_modules/reactive-ts-plugin/index.cjs, so the packaged
...
// `typescriptServerPlugins` contribution names it `reactive-ts-plugin`), so the bundle
