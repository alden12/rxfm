...
// function createHTMLElement<J extends keyof HTMLElementTagNameMap>(tagName: K): HTMLElementTagNameMap[K] {
//   return document.createElement(tagName);
// }

// TODO: Use proxy and interface to prevent regeneration of type for each element? Use ReturnType of factory?
// Don't define as object? Just use proxy?

export type HTMLElementTypes = {
  [K in keyof HTMLElementTagNameMap]: K;
};

export const HTMLElements: HTMLElementTypes = {
  a: 'a',
  abbr: 'abbr',
  address: 'address',
  applet: 'applet',
